...
const links = [
  { to: '/employee', label: 'Tareas', icon: ClipboardList, end: true },
  { to: '/employee/sistema', label: 'Sistema', icon: Activity, end: false },
];
      ...
      <div className="min-h-screen flex">
        <aside className="w-64 shrink-0 border-r border-white/10 bg-slate-950/80 backdrop-blur flex flex-col">
          <div className="px-6 py-8 border-b border-white/10">
            ...
            <p className="text-xs text-slate-500 mt-0.5">Encargado · Integrador</p>
          </div>

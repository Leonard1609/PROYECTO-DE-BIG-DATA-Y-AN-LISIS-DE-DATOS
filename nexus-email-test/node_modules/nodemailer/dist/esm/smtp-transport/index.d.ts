...
import { type SMTPConnectionOptions, type SMTPConnectionAuth, type SMTPConnectionSendInfo } from 'nodemailer/lib/smtp-connection';
import * as shared from 'nodemailer/lib/shared';
import { type XOAuth2Options } from 'nodemailer/lib/xoauth2';
import type { ResultCallback } from 'nodemailer/lib/errors.js';
import type MailMessage from 'nodemailer/lib/mailer/mail-message.js';
import type { default as Mail, SentMessageInfo, SendMailOptions, TransportOptions, VerifyCallback } from 'nodemailer/lib/mailer';
import type { MimeNodeEnvelope } from 'nodemailer/lib/mime-node';
/**

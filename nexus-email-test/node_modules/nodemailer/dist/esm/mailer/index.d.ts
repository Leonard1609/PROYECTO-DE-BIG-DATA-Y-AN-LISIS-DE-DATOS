...
import DKIM, { type DKIMOptions } from 'nodemailer/lib/dkim';
import MailMessage, { type MailDefaults, type SendMailOptions } from 'nodemailer/lib/mailer/mail-message.js';
import net from 'node:net';
import type { ConnectionOptions } from 'node:tls';
import type { MailComposerAlternative, MailComposerAttachment, MailComposerIcalEvent, MailComposerListHeaderEntry, MailComposerListHeaders } from 'nodemailer/lib/mail-composer';
import type { NodemailerError, ResultCallback } from 'nodemailer/lib/errors.js';
import type { ParsedUrl } from 'nodemailer/lib/shared/url.js';
import type { MimeNodeAddress, MimeNodeEnvelope, MimeNodeEnvelopeInput, MimeNodeHeaders, MimeNodeOptions } from 'nodemailer/lib/mime-node';
import type { XOAuth2ProvisionCallback } from 'nodemailer/lib/xoauth2';
export type { SendMailOptions, MailDefaults, MailMessageData, MailMessageDataCallback, MailMessageContentCallback, MailMessageListHeader, MailMessageListHeaderValue } from 'nodemailer/lib/mailer/mail-message.js';
export type { default as MailMessage } from 'nodemailer/lib/mailer/mail-message.js';
/**

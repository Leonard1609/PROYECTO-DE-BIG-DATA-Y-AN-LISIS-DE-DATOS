  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-2xl border border-slate-200">
        <h2 className="text-xl font-bold text-slate-800 mb-1">Completar Datos de Registro</h2>
        <p className="text-xs text-slate-500 mb-4">
          Ingresa el correo empresarial que se te asignó, el código de 6 dígitos enviado a tu Gmail personal y crea tu contraseña.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 mb-1">Código de Verificación *</label>
            <input
              type="text"
              required
              maxLength={6}
